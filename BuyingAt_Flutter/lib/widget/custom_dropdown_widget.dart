...
class CustomDropdown<T> extends StatefulWidget {
  ...
  const CustomDropdown({
    ...
    this.iconPadding, this.iconSize
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                // ],
                Expanded(
                  child: widget.isIndexValue ?  ((_currentIndex != -1 &&
                      _currentIndex >= 0 &&
                ...
                if (!widget.hideIcon)
                  RotationTransition(
                    ...
                    child: Padding(
                      padding: widget.iconPadding ??  EdgeInsets.symmetric(horizontal: 20.w),
                      child: SvgPicture.asset(AppImage.icDropDawn,width: widget.iconSize ?? 14.w,),
                    ),
                  ),
              ],
            ),
