          ...
          child: Container(
            ...
            child: Dialog(
              child: SelectionDialog(
                ...
                topBarPadding: EdgeInsets.zero, hideHeaderText: false,
              ),
            ),
          ),
        ),
      ...
      showModalBottomSheet(
        ...
        builder: (context) => Center(
          child: SelectionDialog(
            ...
            headerTextStyle: interReg.copyWith(fontSize: 24.sp,color: AppColor.coolGray5),
            topBarPadding: EdgeInsets.only(right: 8.w,top: 12.w,left: 26.w),
          ),
        ),
      ).then((e) {
        if (e != null) {
