...
const ShippingAddressForm = ({ data, countries, states }) => {
  ...
  const onSubmit = async (values) => {
    ...
    if (res.status === success) {
      toast.success("Shipping Address updated successfully!", { id: toastId });
    } else {
  ...
  return (
    <aside className="border border-border rounded">
      <p className="px-6 py-4 text-sm font-medium">SHIPPING ADDRESS</p>
      <hr />
